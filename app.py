    ...
    if sentimento_user.strip():
        with st.spinner("Gerando devocional e conselho de Jesus para você..."):
            ...
            try:
                ...
                st.success(f"💬 **Conselho de Jesus:(baseado nas palavras de Jesus nos evangelhos)**\n\n{texto_jesus}")
...
# EXIBE O QR CODE (ajustado)
st.image("QRCODE.jpeg", caption="Faça sua oferta escaneando o QR Code", width=200, use_container_width=True)
