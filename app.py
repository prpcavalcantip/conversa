...
<div style='text-align: center; margin-bottom: 30px;'>
    <a href="https://www.mercadopago.com.br/subscriptions/checkout?preapproval_plan_id=dadca597a91f47be81a6133103eacfa5" name="MP-payButton" class='blue-button'>Assinar agora</a>
</div>
<style>
.blue-button {
...
st.info("Após o pagamento, você terá acesso ao conteúdo exclusivo do app. Caso haja qualquer dúvida, entre em contato com o suporte.")
